...
Lokaler Abschluss: 256 Node-Tests grün; Review-Randfälle durch Tests behoben. Live-Editor anhand Web-App-ID zugeordnet, Router und Modul übernommen. Google-Autorisierung und private Einrichtung abgeschlossen, Backend-Version 94 bereitgestellt, öffentliche deaktivierte Route geprüft. Sammlung bleibt aus; echte Live-Token-Abnahme und Frontend-Veröffentlichung stehen aus. Nach gezieltem UID-/E-Mail-Abgleich wurde die anfängliche falsche Kontozuordnung korrigiert. Das bestätigte gewünschte Betreiberkonto hat das gesetzte und erneut verifizierte Adminrecht; das zuerst angegebene Konto bleibt unverändert.

Live-Abnahme 13.09.2026: Frontend veröffentlicht, Cache-Korrektur 02279d5 wirksam, Sammlung aktiv, echter Adminabruf und zwei Tageszähler (Glossar/Formeln) erfolgreich bei abgelehntem GA. Ungültiges Token live abgewiesen. Zusätzlicher Live-Widerrufstest durch automatische Sicherheitsprüfung vor Ausführung blockiert; bestehendes Adminrecht unverändert. Keine vollständige Testwiederholung bei dieser reinen Abnahme.

Abschluss: Nach ausdrücklicher Freigabe Live-Widerrufstest erfolgreich durchgeführt. Derselbe Browser wurde ohne usageAdmin abgewiesen; Statistikdaten ausgeblendet. usageAdmin unmittelbar wiederhergestellt und per Google verifiziert, übrige Claims unverändert. Kein weiterer manueller Einrichtungsschritt offen.
